...
//function that returns a reference to a string
...
int main()
{
    ...
    inventory.push_back("posioned dagger");
    inventory.push_back("shield");
    
    // displays string that return references belongs to
    ...
    //copies a string object (instead of reference) -- expensive assignment
