// Heap Data Member
// Demonstartes an object with a dynamically allocated data member
...
public:
    ...
    Critter& operator=( const Critter& c);  // overloaded assignment op (space needed before "const")
    void Greet() const;
...
Critter::~Critter()                 // Desconstructor Definition
{
